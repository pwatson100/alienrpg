class ChatDamageButtonsAlien extends Application {
  constructor(app) {
    super(app);
  }
  ...
  init() {
    Hooks.on('renderChatMessage', (message, html, data) => {
      ...
      fullDamageButton.click((ev) => {
        ...
        if (CONFIG.ALIENRPG.chatDamageButtonShieldToggle) {
          ...
          CONFIG.ALIENRPG.chatDamageButtonShieldToggle = false;
        }

        // if (ev.shiftKey) {
        //   ChatDamageButtonsAlien.shiftModifyDamage(html, 1, attribute);
        // } else {
      ...
      //   if (ev.shiftKey) {
      //     ChatDamageButtonsAlien.shiftModifyDamage(html, 0.5, attribute);
      //   } else {
      ...
      //   if (ev.shiftKey) {
      //     ChatDamageButtonsAlien.shiftModifyDamage(html, 2, attribute);
      //   } else {
      ...
      //   ev.stopPropagation();
      //   html.find('.dice-total-shield-btn').toggleClass('shield-activated');
      //   CONFIG.ALIENRPG.chatDamageButtonShieldToggle = CONFIG.ALIENRPG.chatDamageButtonShieldToggle ? false : true;
      // });
      // fullHealingButton.click(ev => {
      //   ev.stopPropagation();

      //   if (ev.shiftKey) {
      //     ChatDamageButtonsAlien.shiftModifyDamage(html, -1);
      //   } else {
...
const chatButtons = new ChatDamageButtonsAlien();
chatButtons.init();
