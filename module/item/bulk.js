...
function calculateItemBulk(item, stackDefinitions, bulkConfig) {
  ...
  if (isBlank(stackName)) {
    ...
    return [calculateNonStackBulk(item).times(1), {}];
  }
...
function calculateCombinedBulk(item, stackDefinitions, nestedExtraDimensionalContainer = false, bulkConfig = {}) {
  ...
  const [childBulk, childOverflow] = item.holdsItems
    ...
    .reduce(combineBulkAndOverflow, [new Bulk(), {}]); // combine item overflow and child overflow
...
export function toBulkItem(item, nestedItems = []) {
  var _item$data,
    _item$data$weight,
    _item$data2,
    _item$data2$quantity,
    _item$data3,
    _item$data3$equipped,
    _item$data4,
    _item$data4$equippedB,
    _item$data5,
    _item$data5$unequippe,
    _item$data6,
    _item$data6$stackGrou,
    _item$data7,
    _item$data7$negateBul,
    _item$data8,
    _item$data8$traits,
    _item$data8$traits$va;

  const id = item._id;
  const weight =
    (_item$data = item.data) === null || _item$data === void 0 ? void 0 : (_item$data$weight = _item$data.weight) === null || _item$data$weight === void 0 ? void 0 : _item$data$weight.value;
  const quantity =
    ((_item$data2 = item.data) === null || _item$data2 === void 0
      ? void 0
      : (_item$data2$quantity = _item$data2.quantity) === null || _item$data2$quantity === void 0
      ? void 0
      : _item$data2$quantity.value) ?? 0;
  const isEquipped =
    ((_item$data3 = item.data) === null || _item$data3 === void 0
      ? void 0
      : (_item$data3$equipped = _item$data3.equipped) === null || _item$data3$equipped === void 0
      ? void 0
      : _item$data3$equipped.value) ?? false;
  const equippedBulk =
    (_item$data4 = item.data) === null || _item$data4 === void 0
      ? void 0
      : (_item$data4$equippedB = _item$data4.equippedBulk) === null || _item$data4$equippedB === void 0
      ? void 0
      : _item$data4$equippedB.value;
  const unequippedBulk =
    (_item$data5 = item.data) === null || _item$data5 === void 0
      ? void 0
      : (_item$data5$unequippe = _item$data5.unequippedBulk) === null || _item$data5$unequippe === void 0
      ? void 0
      : _item$data5$unequippe.value;
  const stackGroup =
    (_item$data6 = item.data) === null || _item$data6 === void 0
      ? void 0
      : (_item$data6$stackGrou = _item$data6.stackGroup) === null || _item$data6$stackGrou === void 0
      ? void 0
      : _item$data6$stackGrou.value;
  const negateBulk =
    (_item$data7 = item.data) === null || _item$data7 === void 0
      ? void 0
      : (_item$data7$negateBul = _item$data7.negateBulk) === null || _item$data7$negateBul === void 0
      ? void 0
      : _item$data7$negateBul.value;
  const extraDimensionalContainer =
    ((_item$data8 = item.data) === null || _item$data8 === void 0
      ? void 0
      : (_item$data8$traits = _item$data8.traits) === null || _item$data8$traits === void 0
      ? void 0
      : (_item$data8$traits$va = _item$data8$traits.value) === null || _item$data8$traits$va === void 0
      ? void 0
      : _item$data8$traits$va.includes('extradimensional')) ?? false;
  return new BulkItem({
    id,
...
export function toBulkItems(items) {
  ...
  const itemsInContainers = groupBy(items, (item) => {
    var _item$data9, _item$data9$container;
    ...
    const ref =
      ((_item$data9 = item.data) === null || _item$data9 === void 0
        ? void 0
        : (_item$data9$container = _item$data9.containerId) === null || _item$data9$container === void 0
        ? void 0
        : _item$data9$container.value) ?? null;
...
export function itemsFromActorData(actorData) {
  const itemsHavingBulk = actorData.items.filter((item) => itemTypesWithBulk.has(item.type));
