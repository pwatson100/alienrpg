    ...
    for await (const [key, item] of Object.entries(manifest)) {
      if (key !== 'entities') {
        ...
        try {
          ...
          const createdEntities = await cls.createDocuments(newentityData);
