...
export default class alienrpgSynthetic extends alienrpgActorBase {
	static LOCALIZATION_PREFIXES = [...super.LOCALIZATION_PREFIXES, "ALIENRPG.Actor.Synthetic"]
	...
	static defineSchema() {
		...
		schema.header = new fields.SchemaField({
			...
			synthstress: new fields.BooleanField({ initial: false }),
		})
