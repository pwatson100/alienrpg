  ...
  _configureRenderOptions(options) {
    ...
    switch (game.settings.get("alienrpg", "evolved")) {
      ...
      case false:
        {
          if (game.settings.get("alienrpg", "aliencrt")) {
            options.parts.push("crtuicharacterheader", "tabs", "crtuicharactergeneral", "crtuicharacterskills", "crtuicharacterinventory", "notes");
          } else {
  ...
  _getTabs(parts) {
    ...
    return parts.reduce((tabs, partId) => {
      ...
      switch (partId) {
        ...
        case "notes":
          tab.id = "notes";
          // tab.label += game.i18n.localize("ALIENRPG.Actor.Tabs.Notes");
          tab.label += "Notes";
          break;
        case "charactergeneral":
          tab.id = "charactergeneral";
          // tab.label += game.i18n.localize("ALIENRPG.Actor.Tabs.General");
          tab.label += "General";
          break;
        case "characterENgeneral":
        ...
        case "skills":
          tab.id = "skills";
          // tab.label += game.i18n.localize("ALIENRPG.Actor.Tabs.Skills");
          tab.label += "Skills";

          break;
        case "inventory":
          tab.id = "inventory";
          // tab.label += game.i18n.localize("ALIENRPG.Actor.Tabs.Inventory");
          tab.label += "Inventory";
          break;
        case "crtuicharacterinventory":
